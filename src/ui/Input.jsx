...
function Input() {
  return (
    <div className="w-full flex items-center h-auto">
      ...
      <button
        type="button"
        className="max-w-[150px] sm:max-w-[282px] w-full flex justify-center items-center gap-[8px] sm:gap-[17px] bg-linear-blue py-[17.5px] sm:py-[15px] pl-[10px] pr-[10px]  sm:pl-[28px] sm:pr-[50px] rounded-r-[16px] text-white text-[14px] sm:text-[23px] text-normal leading-[100%] cursor-pointer border-[1px] border-solid border-[blue]"
      >
        <img
          width={20}
          height={14}
